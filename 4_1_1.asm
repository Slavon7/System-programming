...
.data
    ...
    matrixA1 matrix <1,2,3,4,4,3>   ; инициализация 1 строки массива А  
    matrixA2 matrix <5,4,3,2,2,4>   ; инициализация 2 строки массива А 
    matrixA3 matrix <1,3,5,4,1,5>   ; инициализация 3 строки массива А 
    matrixA4 matrix <3,5,2,4,2,1>   ; инициализация 4 строки массива А 

    matrixB1 matrix <2,1,4,5,3,5>   ; инициализация 1 строки массива В  
    matrixB2 matrix <3,5,2,4,2,5>   ; инициализация 2 строки массива В
    matrixB3 matrix <1,3,5,4,3,1>   ; инициализация 3 строки массива В
    matrixB4 matrix <5,4,3,2,1,3>   ; инициализация 4 строки массива В
    ...
    txt2 db "Задание: Перемножить две матрицы размерами 4х6 и привести результирующую.",10,10,
    "Матрица А ",10,
        "1 2 3 4 4 3",10,   
        "5 4 3 2 2 4",10,
        "1 3 5 4 1 5",10,
...
str15:              ; цикл умножения 4 строки на 4 ряд
    mov rax,[rsi]   ; получение элемента массива А
    mov rdx,[r10]   ; получение элемента массива В
...
mov rcx,4       ; установка кол-ва циклов в 4
    ...
    str16:              ; цикл умножения 4 строки на 4 ряд
    mov rax,[rsi]   ; получение элемента массива А
    mov rdx,[r10]   ; получение элемента массива В
...
loop str24
    ...
    str25:              ; цикл умножения 4 строки на 4 ряд
    mov rax,[rsi]   ; получение элемента массива А
    mov rdx,[r10]   ; получение элемента массива В
...
loop str25
    ...
    str26:              ; цикл умножения 4 строки на 4 ряд
    mov rax,[rsi]   ; получение элемента массива А
    mov rdx,[r10]   ; получение элемента массива В
...
str35:              ; цикл умножения 4 строки на 4 ряд
    mov rax,[rsi]   ; получение элемента массива А
    mov rdx,[r10]   ; получение элемента массива В
...
loop str35
    ...
    str36:              ; цикл умножения 4 строки на 4 ряд
    mov rax,[rsi]   ; получение элемента массива А
    mov rdx,[r10]   ; получение элемента массива В
...
str45:              ; цикл умножения 4 строки на 4 ряд
    mov rax,[rsi]   ; получение элемента массива А
    mov rdx,[r10]   ; получение элемента массива В
...
loop str45
    ...
    str46:              ; цикл умножения 4 строки на 4 ряд
    mov rax,[rsi]   ; получение элемента массива А
    mov rdx,[r10]   ; получение элемента массива В
